...
def main(args):
	tables = [ 
		('tournaments', ['CREATE table `tournaments` (tournamentid INT PRIMARY KEY AUTO_INCREMENT, name VARCHAR(100) UNIQUE, url VARCHAR(100), password VARCHAR(100), rounds INT, pairings BOOLEAN)']),
